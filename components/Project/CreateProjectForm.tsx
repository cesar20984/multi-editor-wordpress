...
add_action( 'rest_api_init', function () {
    ...
    return (
        <form action={createProject} className="glass-panel" style={{ width: '100%', display: 'flex', flexDirection: 'column', padding: '1.5rem', marginBottom: '1.5rem' }}>
            <div style={{ marginBottom: '1rem', fontWeight: 'bold', fontSize: '1.2rem', color: 'var(--text-primary)' }}>✚ Crear Nuevo Proyecto</div>
